...
CREATE TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT (
            IDN_OAUTH2_ACCESS_TOKEN_AUDIT_ID INTEGER NOT NULL IDENTITY,
            TOKEN_ID VARCHAR (255),
            ACCESS_TOKEN VARCHAR(2048),
            REFRESH_TOKEN VARCHAR(2048),
            CONSUMER_KEY_ID INTEGER,
...
CREATE TABLE IDN_OAUTH2_SCOPE_BINDING (
  IDN_OAUTH2_SCOPE_BINDING_ID INTEGER NOT NULL IDENTITY,
...
CREATE TABLE IDN_OAUTH2_RESOURCE_SCOPE (
  IDN_OAUTH2_RESOURCE_SCOPE_ID INTEGER NOT NULL IDENTITY,
...
CREATE TABLE IF NOT EXISTS IDN_AUTH_USER_SESSION_MAPPING (
        IDN_AUTH_USER_SESSION_MAPPING_ID INTEGER NOT NULL IDENTITY,
        USER_ID VARCHAR(255) NOT NULL,
        SESSION_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_CIBA_REQUEST_SCOPES (
        IDN_OAUTH2_CIBA_REQUEST_SCOPES_ID INTEGER NOT NULL IDENTITY,
        AUTH_CODE_KEY CHAR (36),
        SCOPE VARCHAR (255),
...
CREATE TABLE CM_SP_PURPOSE_PURPOSE_CAT_ASSC (
  CM_SP_PURPOSE_PURPOSE_CAT_ASSC_ID INTEGER NOT NULL IDENTITY,
...
CREATE TABLE CM_PURPOSE_PII_CAT_ASSOC (
  CM_PURPOSE_PII_CAT_ASSOC_ID INTEGER NOT NULL IDENTITY,
  PURPOSE_ID         INTEGER NOT NULL,
...
CREATE TABLE CM_SP_PURPOSE_PII_CAT_ASSOC (
  CM_SP_PURPOSE_PII_CAT_ASSOC_ID INTEGER NOT NULL IDENTITY,
  SP_PURPOSE_ASSOC_ID INTEGER NOT NULL,
...
CREATE TABLE CM_CONSENT_RECEIPT_PROPERTY (
  CM_CONSENT_RECEIPT_PROPERTY_ID INTEGER NOT NULL IDENTITY,
  CONSENT_RECEIPT_ID VARCHAR(255)  NOT NULL,
  NAME               VARCHAR(255)  NOT NULL,
