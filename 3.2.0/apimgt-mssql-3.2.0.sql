...
CREATE TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT (
            IDN_OAUTH2_ACCESS_TOKEN_AUDIT_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
            TOKEN_ID VARCHAR (255),
            ACCESS_TOKEN VARCHAR(2048),
            REFRESH_TOKEN VARCHAR(2048),
            CONSUMER_KEY_ID INTEGER,
...
CREATE TABLE IDN_OAUTH2_DEVICE_FLOW_SCOPES (
    ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE IDN_OAUTH2_SCOPE (
  SCOPE_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE IDN_OAUTH2_SCOPE_BINDING (
  IDN_OAUTH2_SCOPE_BINDING_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE IDN_OAUTH2_RESOURCE_SCOPE (
  IDN_OAUTH2_RESOURCE_SCOPE_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE IDN_AUTH_USER_SESSION_MAPPING (
        IDN_AUTH_USER_SESSION_MAPPING_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
        USER_ID VARCHAR(255) NOT NULL,
        SESSION_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE IDN_OAUTH2_CIBA_REQUEST_SCOPES (
        IDN_OAUTH2_CIBA_REQUEST_SCOPES_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
        AUTH_CODE_KEY CHAR (36),
        SCOPE VARCHAR (255),
...
CREATE TABLE CM_SP_PURPOSE_PURPOSE_CAT_ASSC (
  CM_SP_PURPOSE_PURPOSE_CAT_ASSC_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE CM_PURPOSE_PII_CAT_ASSOC (
  CM_PURPOSE_PII_CAT_ASSOC_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
  PURPOSE_ID         INTEGER NOT NULL,
...
CREATE TABLE CM_SP_PURPOSE_PII_CAT_ASSOC (
  CM_SP_PURPOSE_PII_CAT_ASSOC_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
  SP_PURPOSE_ASSOC_ID INTEGER NOT NULL,
...
CREATE TABLE CM_CONSENT_RECEIPT_PROPERTY (
  CM_CONSENT_RECEIPT_PROPERTY_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
  CONSENT_RECEIPT_ID VARCHAR(255)  NOT NULL,
  NAME               VARCHAR(255)  NOT NULL,
...
CREATE TABLE AM_SUBSCRIBER (
    SUBSCRIBER_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_APPLICATION (
    APPLICATION_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_API (
    API_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_API_URL_MAPPING (
    URL_MAPPING_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
    API_ID INTEGER NOT NULL,
...
CREATE TABLE AM_API_PRODUCT_MAPPING (
	API_PRODUCT_MAPPING_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
	API_ID INTEGER,
...
CREATE TABLE AM_SUBSCRIPTION (
    SUBSCRIPTION_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
    TIER_ID VARCHAR(50),
...
CREATE TABLE AM_APPLICATION_REGISTRATION (
    REG_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
    SUBSCRIBER_ID INTEGER,
...
CREATE TABLE AM_API_LC_EVENT (
    EVENT_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
    API_ID INTEGER NOT NULL,
...
CREATE TABLE AM_TIER_PERMISSIONS (
    TIER_PERMISSIONS_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_EXTERNAL_STORES (
    APISTORE_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
    API_ID INTEGER,
...
CREATE TABLE AM_WORKFLOWS(
    WF_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_API_DEFAULT_VERSION (
            DEFAULT_VERSION_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE  AM_ALERT_TYPES (
            ALERT_TYPE_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_ALERT_EMAILLIST (
	     EMAIL_LIST_ID INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
             USER_NAME VARCHAR(255) NOT NULL ,
	     STAKE_HOLDER VARCHAR(100) NOT NULL ,
...
CREATE TABLE AM_POLICY_SUBSCRIPTION (
            POLICY_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_CONDITION_GROUP (
            CONDITION_GROUP_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_QUERY_PARAMETER_CONDITION (
            QUERY_PARAMETER_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_HEADER_FIELD_CONDITION (
            HEADER_FIELD_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
            CONDITION_GROUP_ID INTEGER NOT NULL,
...
CREATE TABLE AM_JWT_CLAIM_CONDITION (
            JWT_CLAIM_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
            CONDITION_GROUP_ID INTEGER NOT NULL,
...
CREATE TABLE AM_IP_CONDITION (
  AM_IP_CONDITION_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_THROTTLE_TIER_PERMISSIONS (
  THROTTLE_TIER_PERMISSIONS_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE AM_BLOCK_CONDITIONS (
  CONDITION_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
