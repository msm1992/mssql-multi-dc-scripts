...
CREATE TABLE REG_LOG (
             REG_LOG_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
...
CREATE TABLE  REG_PATH(
             REG_PATH_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
...
CREATE TABLE  REG_CONTENT (
             REG_CONTENT_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
...
CREATE TABLE  REG_RESOURCE (
            ...
            REG_VERSION          INTEGER IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
...
CREATE TABLE  REG_COMMENT (
            REG_ID      INTEGER IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
...
CREATE TABLE  REG_RESOURCE_COMMENT (
            REG_RESOURCE_COMMENT_ID     INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE  REG_RESOURCE_RATING (
            REG_RESOURCE_RATING_ID      INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE   REG_RESOURCE_TAG (
            REG_RESOURCE_TAG_ID     INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE  REG_RESOURCE_PROPERTY (
            REG_RESOURCE_PROPERTY_ID    INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
...
CREATE TABLE  REG_ASSOCIATION (
            REG_ASSOCIATION_ID  INTEGER IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
...
CREATE TABLE REG_SNAPSHOT (
            REG_SNAPSHOT_ID     INTEGER IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
            REG_PATH_ID            INTEGER NOT NULL,
            REG_RESOURCE_NAME            VARCHAR (256),
...
CREATE TABLE UM_TENANT (
			UM_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
...
CREATE TABLE UM_DOMAIN(
            UM_DOMAIN_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
...
CREATE TABLE UM_SHARED_USER_ROLE(
    UM_SHARED_USER_ROLE_ID      INTEGER NOT NULL IDENTITY(1,1) NOT FOR REPLICATION,
    UM_ROLE_ID INTEGER NOT NULL,
    UM_USER_ID INTEGER NOT NULL,
...
CREATE TABLE UM_ACCOUNT_MAPPING(
	UM_ID INTEGER IDENTITY(1,1) NOT FOR REPLICATION,
	UM_USER_NAME VARCHAR(255) NOT NULL,
